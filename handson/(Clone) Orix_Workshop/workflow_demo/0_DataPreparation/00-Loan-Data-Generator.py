...
# MAGIC %md
# MAGIC # DLTパイプラインのためのデータジェネレーター
# MAGIC このノートブックは、与えられたストレージパスにデータを生成し、データフローをシミュレートします。
# MAGIC
# MAGIC **Make sure the storage path matches what you defined in your DLT pipeline as input.**.
# MAGIC
# MAGIC 1. ウィジェットを表示するためにCmd 2を実行する
# MAGIC 2. ウィジェットでストレージパスを指定する
# MAGIC 3. "Run All "でデータを生成する
# MAGIC 4. データ生成が終了したら、"Stop Execution "を実行します。
# MAGIC
